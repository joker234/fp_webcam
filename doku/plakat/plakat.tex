...
%\begin{picture}(0,0)
%	\put(20.0, 280){\includegraphics[height=60mm]{iwr_logo/IWR-Logo-2cm-600.png}}
%\end{picture}
...
\begin{multicols}{2}
	...
	\begin{figurehere}
		\centering
		\includegraphics{cam_platine.png}
	\end{figurehere}
...
\begin{multicols}{2}
	...
	Einsatz, beeinflussen. Hier folgt die vom Worker aufgerufene Funktion
	move():
